...
// Menú SentinelMod - Ver panel de salud de mods
menu.post('/sentinel-dashboard', async (c) => {
  const request = await c.req.json<MenuItemRequest>();
      ...
      showForm: {
        ...
        form: {
          ...
          fields: [
            {
              name: 'info',
              label: 'Panel de monitoreo de moderadores activo',
              type: 'string',
              defaultValue: 'Ver estadísticas en el post de SentinelMod',
              required: false,
            },
          ],
          acceptLabel: 'Ver Dashboard',
          cancelLabel: 'Cerrar',
        },
      },
    },
